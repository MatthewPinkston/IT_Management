<?php
    ...
    if(isset($_POST['edit']) && $_POST['edit'] == 'edit'){
        ...
        $sql = 'UPDATE Asset_Tracking SET name=?, type=?, totalPurchased=?, inStock=?, inCondition=?, assigned=?, notInCondition=? WHERE id=?';
        ...
        mysqli_stmt_bind_param($stmt, "ssiiiiis", $assetName, $assetType, $totalPurchased, $inStock, $inCondition, $assigned, $notInCondition, $id);
